// types
import { Message, ReservationsList } from './reservationTypes';
...
const ReservationsMessages: Message[] = [
    {
        id: 1,
        avatar: "avatar1",
        sender: 'Chadengle',
...
const ReservationsDetails: ReservationsList[] = [
    {
        id: 1,
...
export { ReservationsMessages, ReservationsDetails };
