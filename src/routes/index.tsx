...
const ViewAllReservations = React.lazy(() => import('../pages/dashboards/DashBoard1/ViewAllReservations'));
...
const SkillsInterest =  React.lazy(() => import('../pages/dashboards/DashBoard1/SkillsInterest'));
      ...
      children: [
        ...
        
        {
          ...
          children: [
            ...
            {
              path: 'skillsInterest',
              element: <LoadComponent component={SkillsInterest} />,
            },
            {
            ...
            },
            {
              ...
              element: <LoadComponent component={ViewAllReservations} />,
            },
            {
              path: 'discount',
