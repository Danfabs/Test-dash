...
const BranchesWidget1 = ({ title, color, stats, subTitle }: BranchesWidget1Props) => {
        ...
        <Card>
            <Card.Body>
                <Dropdown className="float-end" align="end">
                    ...
                    <Dropdown.Menu>
                        <Dropdown.Item>Show All Branches</Dropdown.Item>
...
export default BranchesWidget1;
